...
from communicationapp.utils import ensure_alias_for_client

class SimpleJWTUser:
    def _init_(self, user_id, username, permissions, tenant=None):
        self.id = user_id
...
class ExternalJWTAuthentication(BaseAuthentication):
    def authenticate(self, request):
        ...
        # register/attach tenant DB before any ORM use
        try:
            if client_username:
                ...
                raise RuntimeError("No client identifier to register tenant DB.")
